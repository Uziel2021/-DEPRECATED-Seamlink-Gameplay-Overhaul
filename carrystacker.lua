...
if not carry_stacker_setup then
	...
	local ofuncs = {
		managers_player_set_carry = PlayerManager.set_carry,--backup_func('PlayerManager.set_carry'),
		managers_player_drop_carry = PlayerManager.drop_carry,--backup_func('PlayerManager.drop_carry'),
		IntimitateInteractionExt__interact_blocked = IntimitateInteractionExt._interact_blocked--backup_func('IntimitateInteractionExt._interact_blocked'),
	}
